...
test.describe('Location Notes @locations @notes', () => {
  ...
  test.beforeEach(async ({ locationNotesPage }, testInfo) => {
    ...
    const m = testInfo.title.match(/^TC-LOC-NTS-(\d+)/);
    if (m && parseInt(m[1]!, 10) >= 33) return; // FCC band
    await locationNotesPage.ensureEmptyState();
  });

  // ── Core Notes tab behavior ──
 ...
 // Delete row WITHOUT clearing textarea first (delete-only-not-persisting regression check)
  ...
  // ── FCC ──
  test('TC-LOC-NTS-033: Verify a single-character note persists after save and reload', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
  ...
  test('TC-LOC-NTS-034: Verify a 3999-character note persists after save and reload', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-034',
  ...
  test('TC-LOC-NTS-035: Whitespace-only "   " persist', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-035',
  ...
  test('TC-LOC-NTS-036: Leading whitespace "  hello" persist (not trimmed)', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-036',
  ...
  test('TC-LOC-NTS-037: Trailing whitespace "hello  " persist (not trimmed)', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-037',
  ...
  test('TC-LOC-NTS-038: Verify a multi-line note with line breaks persists after save', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-038',
  ...
  test('TC-LOC-NTS-039: Edit prepend', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
  ...
  test('TC-LOC-NTS-040: Edit partial-replace (slice middle)', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    const expected =
  ...
  test('TC-LOC-NTS-041: Edit clear-to-empty (row stays with empty value)', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-041',
  ...
  test('TC-LOC-NTS-042: 2-row positive (smallest multi-row save+reload)', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-042',
  ...
  test('TC-LOC-NTS-043: 5-row positive (smoke at moderate count)', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-043',
  ...
  test('TC-LOC-NTS-044: Mixed-content (row 0 = 1-char, row 1 = 4000-char) save+reload', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-044',
  ...
  test('TC-LOC-NTS-045: Edit row 1 of 2 — row 0 unchanged after save+reload', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
  ...
  test('TC-LOC-NTS-046: Verify deleting the first of two note rows leaves the other', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-046',
  ...
  test('TC-LOC-NTS-047: Verify deleting the last of three note rows leaves the first two', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
  ...
  test('TC-LOC-NTS-048: Verify a note persists after a cancel-then-resave flow', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    await locationNotesPage.ensureEmptyState();
  ...
  test('TC-LOC-NTS-049: Verify reloading during the save dialog does not persist the note', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
  ...
  test('TC-LOC-NTS-050: Verify pressing Escape on the save dialog cancels without saving', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    const realPage = locationNotesPage.page;
    await locationNotesPage.ensureEmptyState();
  ...
  test('TC-LOC-NTS-051: Verify the save dialog behavior when clicking outside it', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    const realPage = locationNotesPage.page;
    await locationNotesPage.ensureEmptyState();
  ...
  test('TC-LOC-NTS-053: Sequential save persists most recent value', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
  ...
  test('TC-LOC-NTS-054: Verify saving Notes does not leave the Currency tab unsaved', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    const realPage = locationNotesPage.page;
    await locationNotesPage.ensureEmptyState();
  ...
  test('TC-LOC-NTS-055: Verify saved note rows persist by content after reload', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-055',
  ...
  test('TC-LOC-NTS-057: Tab character "a\\tb" persist', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(60_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-057',
  ...
  test('TC-LOC-NTS-058: Edit append', { tag: '@fcc' }, async ({ locationNotesPage, dependencyGate }) => {
    dependencyGate([]);
    test.setTimeout(90_000);
    await saveAndVerifyCase({
      id: 'TC-LOC-NTS-058',
